...
class Model:
    ...
    def create_user(self, username, age):
        ...
        Examples:
            >>> model.create_user("Harry", 12)
            >>> model._show_list(model.user_list)
            ['Illia, age: 20', 'Maks, age: 20', 'Harry, age: 12']
            >>> model.create_user("Harry", 1000)
    ...
    def remove_user(self, username):
        ...
        Examples:
            >>> model.remove_user("Ron")
            Traceback (most recent call last):
            Exception: [ERROR]::There is no user with such name.
            >>> model.remove_user("Harry")
            >>> model._show_list(model.user_list)
            ['Illia, age: 20', 'Maks, age: 20']
        """
    ...
    def add_book(self, title, author, year=None):
        ...
        Examples:
            ...
            ["'book1', author:author1; year:1990 ", "'boook2', author:author2; year:2000 ", "'Dialogs', author:Seneka;", "'Witchcraft: Special edition', author:Angry Witcher;"]
        """
    ...
    def remove_book(self, title):
        ...
        Examples:
            ...
            >>> model._show_list(model.book_list)
            ["'book1', author:author1; year:1990 ", "'boook2', author:author2; year:2000 ", "'Witchcraft: Special edition', author:Angry Witcher;"]
        """
    ...
    def take_book(self, username, book_title):
        ...
        Examples:
            ...
            ["'book1', author:author1; year:1990 "]
        """
    ...
    def return_book(self, username, book_title):
        ...
        Examples:
            ...
            ["'boook2', author:author2; year:2000 "]
        """
        if not (self._is_book_title_exists(book_title) \
        and self._is_username_exists(username)):
            raise Exception("[ERROR]::There is no such user or book.")
